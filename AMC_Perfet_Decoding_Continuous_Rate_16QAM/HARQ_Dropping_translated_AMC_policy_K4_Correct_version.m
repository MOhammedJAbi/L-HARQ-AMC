        ...
        while counter<N_realization-3
            ...
            if ack_round_1==1
                ...
                if rate_round_1>=rate_round_2
                    wep_round_2=Qam_r(gamma(counter))+Qam_r(gamma(counter+1))<rate_round_1;
                    ...
                    if ack_round_2==1
                        ...
                        if rate_round_1>=rate_round_3
                            wep_round_3=Qam_r(gamma(counter))+Qam_r(gamma(counter+1))+Qam_r(gamma(counter+2))<rate_round_1;
                            ...
                            if ack_round_3==1
                                ...
                                if rate_round_1>=rate_round_4
                                    wep_round_4=Qam_r(gamma(counter))+Qam_r(gamma(counter+1))+Qam_r(gamma(counter+2))+Qam_r(gamma(counter+3))<rate_round_1;
...
save HARQ_Dropping_translated_AMC_policy_16QAM_K_4_Perfect_Decoding_continuous_R_dop_0.05_rho_0.95_V_LHARQ_Correct_q.mat  dop rho SNRdB ...
