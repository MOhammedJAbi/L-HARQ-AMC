...
xx0=10.*log10(Qam_th(Rate_transmission-Rate_parity_Set(i)))
xx=[xx0 xx0+1e-6 xx0+1e-4 xx0+1e-3];
yy=[1,1e-2,1e-3,1e-6];
%semilogy(10.*log10(Qam_th(Rate_transmission-Rate_parity_Set(i))),WEP_parfait(SNRLin,Rate_transmission-Rate_parity_Set(i),g),'-.m','linewidth',1.2)
semilogy(xx,yy,'-.^m','markerfacecolor','m','MarkerSize',7,'linewidth',1.2)
...
xx=[xx0 xx0+1e-6 xx0+1e-4 xx0+1e-3];
yy=[1,1e-2,1e-3,1e-6];
semilogy(xx,yy,'-.sb','markerfacecolor','b','MarkerSize',7,'linewidth',1.2)
...
xx=[xx0 xx0+1e-6 xx0+1e-4 xx0+1e-3];
yy=[1,1e-2,1e-3,1e-6];
semilogy(xx,yy,'-.or','markerfacecolor','r','MarkerSize',7,'linewidth',1.2)
...
xx=[xx0 xx0+1e-6 xx0+1e-4 xx0+1e-3];
yy=[1,1e-2,1e-3,1e-6];
semilogy(xx,yy,'-.vk','markerfacecolor','k','MarkerSize',7,'linewidth',1.2)
...
xx=[xx0 xx0+1e-6 xx0+1e-4 xx0+1e-3];
yy=[1,1e-2,1e-3,1e-6];
semilogy(xx,yy,'-.pg','markerfacecolor','g','MarkerSize',7,'linewidth',1.2)
