...
semilogy(10.*log10(SNRLin),WEP_set(:,1),'-r','linewidth',1.2)
...
semilogy(10.*log10(SNRLin),WEP_set(:,1),'-b','linewidth',1.2)
p0=81;
p1=2;
y2=WEP_set((p0:p1:end),1);
x2=SNRLin(p0:p1:end);
...
semilogy(10.*log10(SNRLin),WEP_set(:,1),'-m','linewidth',1.2)
p0=105;
p1=2;
y2=WEP_set((p0:p1:end),1);
x2=SNRLin(p0:p1:end);
...
semilogy(10.*log10(SNRLin),WEP_set(:,1),'-k','linewidth',1.2)
p0=86;
p1=4;
y2=WEP_set((p0:p1:end),1);
x2=SNRLin(p0:p1:end);
...
legend('R=1.5XX','R=2.25','R=3','R=3.75','Location','NorthEast')
axis([02 20 5e-4 1])
set(gca,'fontsize',11)
ll=legend;
set(ll,'FontSize',15);
