...
plot(10,10,'--g>','markerfacecolor','g','MarkerSize',7)
plot(10,10,'--<','Color',colour_peach,'MarkerEdgeColor',colour_peach,'markerfacecolor',colour_peach,'MarkerSize',7)

hold on

% L-HARQ, problem of renewal-reward K=2
...
% L-HARQ, problem of renewal-reward K=4
...
plot(SNRdB,AMC_eta(1,:),'-m','linewidth',1.2)
amrk1=AMC_eta(1,(3:5:end-2));

plot(SNRdB,AMC_eta(4,:),'-b','linewidth',1.2)
amrk2=AMC_eta(4,(4:5:end-2));

load LHARQ_allocation_translated_AMC_policy_16QAM_turbo_code_K_2_dop_0.05_rho_0.95.mat 
plot(SNRdB,throughput_lharq,'--g','linewidth',1.2)
amrk3=throughput_lharq(2:5:end-2)

hold on
load LHARQ_allocation_translated_AMC_policy_16QAM_turbo_code_K_4_dop_0.05_rho_0.95.mat 
plot(SNRdB,throughput_lharq,'--','Color',colour_peach,'linewidth',1.2)
amrk4=throughput_lharq(3:5:end)
...
plot(SNRdB(2:5:end-2),amrk3,'g>','markerfacecolor','g','MarkerSize',7)
plot(SNRdB(3:5:end-2),amrk4,'<','MarkerEdgeColor',colour_peach,'markerfacecolor',colour_peach,'MarkerSize',7)
...
legend(' Erg',' AM',' HA',' LH2Ox',' LH4O',' AllocatLH2Ox',' AllocatLH4O','Location','SouthEast')
axis([-5 30 0 4])
...
name_figure = 'LHARQ_allocation_rho95_TC';
