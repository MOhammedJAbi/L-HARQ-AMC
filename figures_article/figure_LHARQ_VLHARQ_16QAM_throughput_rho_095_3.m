...
%throughput_lharq_delta_1_K_2=throughput_lharq(1,(1:18));

%load LHARQ_translated_AMC_policy_16QAM_K_2_Perfect_Decoding_continuous_R_dop_0.05_rho_0.95_V_LHARQ_Correct_Part2.mat
%throughput_lharq_delta_1_K_2=[throughput_lharq_delta_1_K_2 throughput_lharq(1,(19:end))];
%
...
throughput_lharq_delta_1_K_4=throughput_lharq(1,(1:18));
...
throughput_lharq_delta_1_K_4=[throughput_lharq_delta_1_K_4 throughput_lharq(1,(19:end))];
%
...
%plot(SNRdB,throughput_vlharq(1,:),'-.','Color',colour_darkblue,'linewidth',1.2)
%amrk11=throughput_vlharq(1,6:5:end-2);

load VLHARQ_translated_AMC_policy_16QAM_K_4_Perfect_Decoding_continous_R_dop_0.05_rho_0.95.mat
plot(SNRdB,throughput_vlharq(1,:),'-.k','linewidth',1.2)
amrk22=throughput_vlharq(1,(7:5:end-2));
...
plot(SNRdB,T_corre,'--g','linewidth',1.2)
amrk1=T_corre(6:5:end-2);
plot(SNRdB(6:5:end-2),amrk1,'^g','markerfacecolor','g','MarkerSize',7)
...
legend(' Erg',' AM',' HA',' LH4o',' VLH4o',' XPH4o','Location','SouthEast')
axis([-5 30 0 4])
