...
f_threshold1=@(x,R,av_snr) 1-marcumq(sqrt(rho*2.*x./((1-rho).*av_snr)),sqrt(2.*(2.^R-1)./((1-rho).*av_snr)));
% Legend integral
lint = 1e2;
...
save LHARQ_outage_policy_16QAM_Perfect_Decoding_continuous_R_dop_0.05_rho_0.95_V_leger_temp.mat dop rho SNRdB snr_range ...
